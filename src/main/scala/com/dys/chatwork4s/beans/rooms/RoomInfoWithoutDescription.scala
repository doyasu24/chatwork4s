...
/**
  ...
  * ]
  */
case class RoomInfoWithoutDescription(
                                       roomId: Long,
                                       name: String,
                                       roomType: RoomType,
                                       role: String,
...
object RoomInfoWithoutDescription {
  implicit val reads: Reads[RoomInfoWithoutDescription] = (
    (JsPath \ "room_id").read[Long] and
      ...
      (JsPath \ "last_update_time").read[Long]
    ) (RoomInfoWithoutDescription.apply _)
}
